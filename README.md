...
- [Демо на GitHub Pages](https://kateshishkova.github.io/VK_Marusya/)
- [Репозиторий](https://github.com/kateshishkova/VK_Marusya)
...
Для опубликованной версии на GitHub Pages приложение использует `HashRouter`, поэтому адреса в браузере имеют вид `/#/...`. Ниже указаны логические маршруты приложения без hash-префикса.
...
Для базовой локальной проверки проекта можно использовать:
